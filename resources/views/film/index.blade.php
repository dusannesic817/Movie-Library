                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <div class="d-flex justify-content-end" style="margin-top: 5rem">Order</div>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-12">
                            <div class="d-flex justify-content-start">
                                <div class="ms-2 me-3 mb-2 d-flex">
                                   <p class="me-2" style="font-weight: bold;">Directors:</p>
                                ...
                                <div class="d-flex  me-3">
                                    <p class="me-2"  style="font-weight: bold;">Stars:</p>
                                    @foreach($film->stars as $p)
                                    <div class="me-2">{{$p->full_name}}</div>
                                    @endforeach
                                </div>
                                <div class="d-flex">
                                    <p class="me-2" style="font-weight: bold;">Writers:</p>
